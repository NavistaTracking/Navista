...
import { FaRocket, FaNetworkWired, FaRobot, FaMicrochip, FaBrain, FaProjectDiagram, FaStar, FaTruck, FaChartLine, FaClock, FaGlobe, FaBolt, FaRoute, FaCog, FaShieldAlt, FaMapMarkerAlt } from 'react-icons/fa';
